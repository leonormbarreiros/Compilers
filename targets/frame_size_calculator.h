...
namespace l22
{
    ...
    public:
        frame_size_calculator(std::shared_ptr<cdk::compiler> compiler, cdk::symbol_table<l22::symbol> &symtab, std::shared_ptr<l22::symbol> function) : basic_ast_visitor(compiler), _symtab(symtab), _function(function), _localsize(0)
        {
        }
