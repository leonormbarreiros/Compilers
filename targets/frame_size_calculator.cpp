...
void l22::frame_size_calculator::do_with_change_node(l22::with_change_node * const node, int lvl) {
  // EMPTY
}

void l22::frame_size_calculator::do_sweep_node(l22::sweep_node * const node, int lvl) {
  // EMPTY
}
