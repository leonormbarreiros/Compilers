...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    tFOREIGN = 259,                /* tFOREIGN  */
    tUSE = 260,                    /* tUSE  */
    tPUBLIC = 261,                 /* tPUBLIC  */
    tPRIVATE = 262,                /* tPRIVATE  */
    tREAL = 263,                   /* tREAL  */
    tIDENTIFIER = 264,             /* tIDENTIFIER  */
    tSTRING = 265,                 /* tSTRING  */
    tBEGIN = 266,                  /* tBEGIN  */
    tEND = 267,                    /* tEND  */
    tINT_TYPE = 268,               /* tINT_TYPE  */
    tREAL_TYPE = 269,              /* tREAL_TYPE  */
    tSTRING_TYPE = 270,            /* tSTRING_TYPE  */
    tVOID_TYPE = 271,              /* tVOID_TYPE  */
    tVAR = 272,                    /* tVAR  */
    tWHILE = 273,                  /* tWHILE  */
    tDO = 274,                     /* tDO  */
    tIF = 275,                     /* tIF  */
